...
class TestModelsComment(TestCase):
	...
	def test_textComment(self):
		...
		self.assertEquals(field_label, 'Nice Post')
	...
	def test_Comment_str(self):
		comment = Comment.objects.get(id=1)
		self.assertEquals(str(comment),'Nice Post')
